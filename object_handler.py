...
class ObjectHandler:
    def __init__(self, game):
        ...
        self.npc_types = [RedDemonNPC, MeleeDemon, BigDemon]
       ...
       # add_sprite(AnimatedSprite(game, pos=(1.5, 1.5)))
        add_sprite(figthingGloves(game, pos=(1.5, 7.5)))
        add_sprite(shoutgun(game, pos=(5.5, 3.25)))
        add_sprite(healthPOT(game, pos=(5.5, 4.75)))
        add_sprite(AnimatedSprite(game, pos=(7.5, 2.5)))
        add_sprite(AnimatedSprite(game, pos=(7.5, 5.5)))
        add_sprite(AnimatedSprite(game, pos=(14.5, 1.5)))
        add_sprite(SpriteObject(game, pos=(14.5, 4.5)))
        add_sprite(AnimatedSprite(game, pos=(14.5, 5.5)))
        add_sprite(healthPOT(game, pos=(14.5, 7.5)))
        add_sprite(AnimatedSprite(game, pos=(12.5, 7.5)))
        add_sprite(AnimatedSprite(game, pos=(9.5, 7.5)))
        add_sprite(SpriteObject(game, pos=(14.5, 12.5)))
        add_sprite(AnimatedSprite(game, pos=(9.5, 20.5)))
        add_sprite(SpriteObject(game, pos=(10.5, 20.5)))
        ...
        add_sprite(healthPOT(game, pos=(1.5, 30.5)))
